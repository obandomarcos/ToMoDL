...
# Model dictionary
    ...
    if 'train_l1' in testing_options:
        ...
        for acceleration in accelerations:
            ...
            for fold in range(len(datasets_list)//trainer_dict['k_fold_number_datasets']):
                ...
                model_system_dict['save_path'] = 'Unet_FA{}_Kfold{}'.format(acceleration, fold)

                wandb.init(project = 'unet', name = model_system_dict['save_path'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_l1', help = 'Train w/L1 loss with optimal hyperparameters', action="store_true")
    ...
    if args.train_l1:
        ...
        print('Training UNET with L1 loss...')
        train_options.append('train_l1')
    ...
    if args.load_unet:
        ...
        print('Loading UNet...')
        train_options.append('load_unet')
