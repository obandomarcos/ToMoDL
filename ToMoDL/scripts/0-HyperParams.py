...
if __name__ == '__main__':
    ...
    wandb.init(project = 'hyperparams_psnr', config = {'K_iterations': 8, 'number_layers' : 8, 'use_batch_norm' :  False})
    ...
    if use_default_model_dict == True:
        ...
        resnet_options_dict = {'number_layers': wandb.config.number_layers,
                            'kernel_size':3,
                            'features':64,
                            'in_channels':1,
                            'out_channels':1,
        ...
        modl_dict = {'use_torch_radon': False,
                    'metric': metric,
                    'K_iterations' : wandb.config.K_iterations,
