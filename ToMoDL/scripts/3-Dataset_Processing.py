...
dataset_path = where_am_i("datasets")
import argparse
import numpy as np
...
def process_datasets(args_options):
    ...
    folder_paths = [
        f"{dataset_path}DataOPT/140114_5dpf",
        f"{dataset_path}DataOPT/140117_3dpf",
        f"{dataset_path}DataOPT/140315_1dpf",
        f"{dataset_path}DataOPT/140315_3dpf",
        f"{dataset_path}DataOPT/140415_5dpf_4X",
        f"{dataset_path}DataOPT/140519_5dpf",
        f"{dataset_path}DataOPT/140714_5dpf",
        f"{dataset_path}DataOPT/140827_3dpf_4x",
        f"{dataset_path}DataOPT/140827_5dpf_4x",
    ]
